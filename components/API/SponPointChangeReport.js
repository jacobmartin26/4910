...
//             try {
//                 const response = await API.get('/pointchange/' + id); 
...
//     // Filter point changes based on date range and name
...
//         const containsSearchName = (!searchName || change.driver.toLowerCase().includes(searchName.toLowerCase()));
//         return withinDateRange && containsSearchName;
//     });

//     // Group point changes by driver
...
//     console.log("Filtered Point Changes:", filteredPointChanges);
...
//                         key={index}
//                         dataKey="numPoints"
//                         name={entry.driver} // Only driver's name here
//                         data={entry.changes}
//                     />
//                 ))}
//             </LineChart>
