...
export const addProductToCart = (user_id, trackId, trackName, artworkUrl100, trackPrice) => (dispatch) => {
  //console.log("ECOMM STUFF: ", user_id);
  //console.log(trackId);
  API.post('add_product', { user_id, trackId, trackName, artworkUrl100, trackPrice }).then((res) => {
